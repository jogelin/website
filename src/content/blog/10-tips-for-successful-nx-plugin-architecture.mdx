...
coverImage: https://cdn.hashnode.com/res/hashnode/image/upload/v1736422834786/96e34dce-d757-4756-86c4-c1dbeb5dcbdb.webp
canonicalUrl: https://gelinjo.hashnode.dev/10-tips-for-successful-nx-plugin-architecture
tags:
  - nx
  - monorepo
  - angular
...
![](https://miro.medium.com/v2/resize:fit:1400/1*XBIhWNoagHdjyWl_w3eXSg.png)
...
[Read: poly monorepos with nx](/blog/poly-monorepos-with-nx) 
...
![](https://miro.medium.com/v2/resize:fit:1400/1*o_BGHDVXa8mwwL3S39B7EQ.png)

### **Generators Simplification**

They **become simpler** because custom configurations are handled within the plugin itself:

![](https://miro.medium.com/v2/resize:fit:1400/1*e8XmeTZFfL0GHK9gKAz2cQ.png)
...
![](https://miro.medium.com/v2/resize:fit:1400/1*yhl-X3gofLfgqllDXrPMQw.png)
...
![](https://miro.medium.com/v2/resize:fit:1400/1*4khIeFbzS_60QlGWulsy2g.png)
...
🚫 If you mix and expose all of these features in [one big barrel file](https://dev.to/thepassle/a-practical-guide-against-barrel-files-for-library-authors-118c), you can **import undesired libraries** and have **performance issues** when using them:

![](https://miro.medium.com/v2/resize:fit:1400/1*k0lc_XQceUNPc2f6976rPg.png)
...
![](https://miro.medium.com/v2/resize:fit:1400/1*za9uja3NRT3qCC6ScChnUA.png)
...
![](https://miro.medium.com/v2/resize:fit:1400/1*peHb60LYaC0T4jCgbUwihA.png)
...
![](https://miro.medium.com/v2/resize:fit:1314/1*s9C88y_GAz9Ew5fALlmkEg.png)
...
![](https://miro.medium.com/v2/resize:fit:1400/1*06XP5NgGPTHRwC431uD3EQ.png)
...
![](https://miro.medium.com/v2/resize:fit:1400/0*xlPPcTePtU12d8w-.png)
...
> *You can find more details on the plugin architecture in my following article* [***🏘️ Poly Monorepos with Nx***](https://itnext.io/%EF%B8%8F-poly-monorepos-with-nx-dd7f5578e3fa)
...
![](https://miro.medium.com/v2/resize:fit:1310/1*I4CPt18X-qTAbGfXBHtSeg.png)
...
![](https://miro.medium.com/v2/resize:fit:1400/1*6RqOJ_qxNbjriBwFWElkhQ.png)
...
[Read: discovering nx project crystals magic](/blog/discovering-nx-project-crystals-magic) 

[  
](https://medium.com/tag/monorepo?source=post_page-----16c07e8bb3e0--------------------------------)