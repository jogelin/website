...
coverImage: https://cdn.hashnode.com/res/hashnode/image/upload/v1723702232854/a562507a-62b0-41ac-bbe1-853e5c7e2204.png
canonicalUrl: https://gelinjo.hashnode.dev/cherry-picked-nx-v196-updates
tags:
  - nx
  - monorepo
  - angular
...
![](https://cdn-images-1.medium.com/max/800/0*F7YI9WEt42ZgISS7.png)

### The NxRuntimeLibraryControlPlugin

> 🖨 ️[Copied from the Nx documentation](https://nx.dev/concepts/module-federation/nx-module-federation-technical-overview) by [Colum Ferry](https://medium.com/u/3ba2fddcf7aa)
...
Following the introduction of AI into Nx’s documentation (via [AI Chat](https://nx.dev/ai-chat)) and Nx Cloud (via [Tusky](https://www.youtube.com/watch?v=Xfvv09wSoM8)), a new [Explain With AI](https://nx.dev/ci/troubleshooting/explain-with-ai) feature is now available. This tool helps developers quickly understand complex errors and provides suggestions for improvements, streamlining the debugging process.

[![](https://cdn.hashnode.com/res/hashnode/image/upload/v1723702508275/bc946c14-72d9-41ef-8633-6310798a5d9c.png)](https://nx.dev/blog/explain-with-ai)
...
[![](https://cdn.hashnode.com/res/hashnode/image/upload/v1723714090402/a21b5708-e420-40c1-8e0a-d58ab7698b07.png)](https://blog.ninja-squad.com/2024/08/14/what-is-new-angular-18.2/)
...
![](https://cdn-images-1.medium.com/max/800/0*f3DpsJO3OaI_EHX_)
