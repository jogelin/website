---
title: "👥 Reproducible Nx Workspace with HugeNx’s Conventions"
subtitle: "An Opinionated Approach to Maintaining and Scaling HugeNx Monorepos"
publishedAt: 2024-05-05
coverImage: https://cdn.hashnode.com/res/hashnode/image/upload/v1714888462253/159379a6-db29-4785-84b6-f8315e8f99a0.png
canonicalUrl: https://gelinjo.hashnode.dev/reproducible-nx-workspace-with-hugenxs-conventions
tags:
  - nx
  - nx-workspace
  - monorepo
...
![](https://miro.medium.com/v2/resize:fit:1400/1*-qLEVpoWbkoY0QeYoCL3gg.png)
...
![](https://miro.medium.com/v2/resize:fit:1400/1*jXNpK44vmxx3Ks9u9ib2uw.png)
...
> *I already explain the importance of conventions in my article ⚡* [***The Super Power of Conventions with Nx***](https://medium.com/@jgelin/the-super-power-of-conventions-with-nx-8d418150b679)***.***
...
If you want to create a **more advanced workspace**, you’ll need t[o create your custom preset](https://nx.dev/extending-nx/recipes/create-preset). It is useful for creating a seed but not for quickly generating a workspace **for comparison**, demo, or workshop; it can be **cumbersome**.
...
![](https://miro.medium.com/v2/resize:fit:1400/1*5WqFJuSp4eKAE9KnLTZThA.png)
...
![](https://miro.medium.com/v2/resize:fit:1400/1*SdBxw1YwzgHI8uUhlkbjKg.png)
