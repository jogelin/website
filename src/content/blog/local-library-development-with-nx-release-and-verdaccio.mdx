---
title: "📤 Local Library Development with Nx Release and Verdaccio"
subtitle: "Automating Your Workflow with Custom Scripts and Verdaccio in Nx Environments"
publishedAt: 2024-03-21
coverImage: https://cdn.hashnode.com/res/hashnode/image/upload/v1731760606551/3a51a4c6-3ae8-4a5b-8102-19048b86aecf.png
canonicalUrl: https://gelinjo.hashnode.dev/local-library-development-with-nx-release-and-verdaccio
tags:
  - nx
  - typescript
  - angular
...
In my previous article, [🍒 Cherry-Picked Nx v18.1 Updates](https://medium.com/@jgelin/cherry-picked-nx-v18-1-updates-067889301e55), I highlighted how the custom `publish.mjs` will now be replaced by the **Nx Release** for managing publishable libraries.

**Nx Release** is mainly achieving three main phases:

![](https://miro.medium.com/v2/resize:fit:1400/1*FN_dCsWHYUhc2yethamQ1g.png)

For those unfamiliar with **Nx Release**, I recommend:

* Reading [Juri Strumpflohner](https://medium.com/u/71b649cf0618?source=post_page-----019af5c5bec0--------------------------------)’s article: [Versioning and Releasing Packages in a Monorepo](https://blog.nrwl.io/versioning-and-releasing-packages-in-a-monorepo-45ee194378d1).
